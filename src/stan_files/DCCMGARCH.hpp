...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(144, 142, "end", "model_DCCMGARCH");
    return reader;
}
...
#include <meta_header.hpp>
 class model_DCCMGARCH : public prob_grad {
private:
    int T;
    int nt;
    vector<vector_d> rts;
...
public:
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        if (!(context__.contains_r("a_q")))
            throw std::runtime_error("variable a_q missing");
        vals_r__ = context__.vals_r("a_q");
        pos__ = 0U;
        context__.validate_dims("initialization", "a_q", "double", context__.to_vec());
        double a_q(0);
        a_q = vals_r__[pos__++];
        try {
            writer__.scalar_lub_unconstrain(0,1,a_q);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable a_q: ") + e.what());
        }

        if (!(context__.contains_r("b_q")))
            throw std::runtime_error("variable b_q missing");
        vals_r__ = context__.vals_r("b_q");
        pos__ = 0U;
        context__.validate_dims("initialization", "b_q", "double", context__.to_vec());
        double b_q(0);
        b_q = vals_r__[pos__++];
        try {
            writer__.scalar_lub_unconstrain(0,(1 - a_q),b_q);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable b_q: ") + e.what());
        }
        ...
        validate_non_negative_index("S", "nt", nt);
        validate_non_negative_index("S", "nt", nt);
        context__.validate_dims("initialization", "S", "matrix_d", context__.to_vec(nt,nt));
        matrix_d S(static_cast<Eigen::VectorXd::Index>(nt),static_cast<Eigen::VectorXd::Index>(nt));
        for (int j2__ = 0U; j2__ < nt; ++j2__)
            for (int j1__ = 0U; j1__ < nt; ++j1__)
                S(j1__,j2__) = vals_r__[pos__++];
        try {
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            vector<Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,Eigen::Dynamic> > R(T, (Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,Eigen::Dynamic> (static_cast<Eigen::VectorXd::Index>(nt),static_cast<Eigen::VectorXd::Index>(nt))));
            stan::math::initialize(R, DUMMY_VAR__);
            stan::math::fill(R,DUMMY_VAR__);
            ...
            validate_non_negative_index("Q", "nt", nt);
            validate_non_negative_index("Q", "T", T);
            vector<Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,Eigen::Dynamic> > Q(T, (Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,Eigen::Dynamic> (static_cast<Eigen::VectorXd::Index>(nt),static_cast<Eigen::VectorXd::Index>(nt))));
            stan::math::initialize(Q, DUMMY_VAR__);
            stan::math::fill(Q,DUMMY_VAR__);
            current_statement_begin__ = 47;
            validate_non_negative_index("Q_sdi", "nt", nt);
            validate_non_negative_index("Q_sdi", "T", T);
            vector<Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1> > Q_sdi(T, (Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1> (static_cast<Eigen::VectorXd::Index>(nt))));
            stan::math::initialize(Q_sdi, DUMMY_VAR__);
            stan::math::fill(Q_sdi,DUMMY_VAR__);
            current_statement_begin__ = 48;
            validate_non_negative_index("u", "nt", nt);
            validate_non_negative_index("u", "T", T);
            vector<Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1> > u(T, (Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1> (static_cast<Eigen::VectorXd::Index>(nt))));
            ...
            stan::model::assign(L_H, 
                        stan::model::cons_list(stan::model::index_uni(1), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), 
                        cholesky_decompose(stan::model::rvalue(Q, stan::model::cons_list(stan::model::index_uni(1), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), "Q")), 
                        "assigning variable L_H");
            current_statement_begin__ = 55;
            stan::model::assign(H, 
                        stan::model::cons_list(stan::model::index_uni(1), stan::model::nil_index_list()), 
                        multiply(get_base1(L_H,1,"L_H",1),transpose(get_base1(L_H,1,"L_H",1))), 
            ...
            stan::model::assign(Q_sdi, 
                        stan::model::cons_list(stan::model::index_uni(1), stan::model::nil_index_list()), 
                        rep_vector(1.0,nt), 
                        "assigning variable Q_sdi");
            ...
            for (int t = 2; t <= T; ++t) {
                ...
                stan::model::assign(Q, 
                            stan::model::cons_list(stan::model::index_uni(t), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), 
                            stan::model::deep_copy(add(add(multiply(((1 - a_q) - b_q),S),multiply(a_q,multiply(stan::model::rvalue(u, stan::model::cons_list(stan::model::index_uni((t - 1)), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), "u"),transpose(stan::model::rvalue(u, stan::model::cons_list(stan::model::index_uni((t - 1)), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), "u"))))),multiply(b_q,stan::model::rvalue(Q, stan::model::cons_list(stan::model::index_uni((t - 1)), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), "Q")))), 
                            "assigning variable Q");
                current_statement_begin__ = 68;
                stan::model::assign(Q_sdi, 
                            stan::model::cons_list(stan::model::index_uni(t), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), 
                            elt_divide(1.0,stan::math::sqrt(diagonal(stan::model::rvalue(Q, stan::model::cons_list(stan::model::index_uni(t), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), "Q")))), 
                            "assigning variable Q_sdi");
                current_statement_begin__ = 70;
                stan::model::assign(R, 
                            stan::model::cons_list(stan::model::index_uni(t), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), 
                            quad_form_diag(stan::model::rvalue(Q, stan::model::cons_list(stan::model::index_uni(t), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), "Q"),stan::model::rvalue(Q_sdi, stan::model::cons_list(stan::model::index_uni(t), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), "Q_sdi")), 
                            "assigning variable R");
            ...
            for (int i0__ = 0; i0__ < T; ++i0__) {
                for (int i1__ = 0; i1__ < nt; ++i1__) {
                    for (int i2__ = 0; i2__ < nt; ++i2__) {
                        if (stan::math::is_uninitialized(Q[i0__](i1__,i2__))) {
                            std::stringstream msg__;
                            msg__ << "Undefined transformed parameter: Q" << '[' << i0__ << ']' << '[' << i1__ << ']' << '[' << i2__ << ']';
                            throw std::runtime_error(msg__.str());
                        }
                    }
                }
            ...
            for (int i0__ = 0; i0__ < T; ++i0__) {
                for (int i1__ = 0; i1__ < nt; ++i1__) {
                    if (stan::math::is_uninitialized(Q_sdi[i0__](i1__))) {
                        std::stringstream msg__;
                        msg__ << "Undefined transformed parameter: Q_sdi" << '[' << i0__ << ']' << '[' << i1__ << ']';
                        throw std::runtime_error(msg__.str());
                    }
                }
            }
            ...
            current_statement_begin__ = 42;
            for (int k0__ = 0; k0__ < T; ++k0__) {
                stan::math::check_corr_matrix(function__,"R[k0__]",R[k0__]);
            }
            current_statement_begin__ = 43;
            current_statement_begin__ = 44;
            current_statement_begin__ = 45;
            current_statement_begin__ = 46;
            for (int k0__ = 0; k0__ < T; ++k0__) {
                stan::math::check_cov_matrix(function__,"Q[k0__]",Q[k0__]);
            }
            current_statement_begin__ = 47;
            current_statement_begin__ = 48;
            ...
            lp_accum__.add(lkj_corr_log<propto__>(S, nt));
    ...
    void get_param_names(std::vector<std::string>& names__) const {
        ...
        names__.push_back("Q_p");
        names__.push_back("Q_sdi_p");
    ...
    void write_array(RNG& base_rng__,
        ...
        matrix_d S = in__.corr_matrix_constrain(nt);
        ...
        try {
            ...
            for (int k_2__ = 0; k_2__ < nt; ++k_2__) {
                for (int k_1__ = 0; k_1__ < nt; ++k_1__) {
                    for (int k_0__ = 0; k_0__ < T; ++k_0__) {
                    vars__.push_back(Q[k_0__](k_1__, k_2__));
                    }
                }
            }
            for (int k_1__ = 0; k_1__ < nt; ++k_1__) {
                for (int k_0__ = 0; k_0__ < T; ++k_0__) {
                vars__.push_back(Q_sdi[k_0__][k_1__]);
                }
            }
            for (int k_1__ = 0; k_1__ < nt; ++k_1__) {
                for (int k_0__ = 0; k_0__ < T; ++k_0__) {
            ...
            validate_non_negative_index("Q_p", "nt", nt);
            validate_non_negative_index("Q_p", "ahead", ahead);
            vector<Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,Eigen::Dynamic> > Q_p(ahead, (Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,Eigen::Dynamic> (static_cast<Eigen::VectorXd::Index>(nt),static_cast<Eigen::VectorXd::Index>(nt))));
            stan::math::initialize(Q_p, DUMMY_VAR__);
            stan::math::fill(Q_p,DUMMY_VAR__);
            current_statement_begin__ = 101;
            validate_non_negative_index("Q_sdi_p", "nt", nt);
            validate_non_negative_index("Q_sdi_p", "ahead", ahead);
            vector<Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1> > Q_sdi_p(ahead, (Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1> (static_cast<Eigen::VectorXd::Index>(nt))));
            stan::math::initialize(Q_sdi_p, DUMMY_VAR__);
            stan::math::fill(Q_sdi_p,DUMMY_VAR__);
            current_statement_begin__ = 102;
            validate_non_negative_index("R_p", "nt", nt);
            validate_non_negative_index("R_p", "ahead", ahead);
            vector<Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,Eigen::Dynamic> > R_p(ahead, (Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,Eigen::Dynamic> (static_cast<Eigen::VectorXd::Index>(nt),static_cast<Eigen::VectorXd::Index>(nt))));
            stan::math::initialize(R_p, DUMMY_VAR__);
            stan::math::fill(R_p,DUMMY_VAR__);
            current_statement_begin__ = 103;
            validate_non_negative_index("u_p", "nt", nt);
            validate_non_negative_index("u_p", "(ahead - 1)", (ahead - 1));
            vector<Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1> > u_p((ahead - 1), (Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1> (static_cast<Eigen::VectorXd::Index>(nt))));
            ...
            stan::model::assign(Q_p, 
                        stan::model::cons_list(stan::model::index_uni(1), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), 
                        add(add(multiply(((1 - a_q) - b_q),S),multiply(a_q,multiply(stan::model::rvalue(u, stan::model::cons_list(stan::model::index_uni(T), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), "u"),transpose(stan::model::rvalue(u, stan::model::cons_list(stan::model::index_uni(T), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), "u"))))),multiply(b_q,stan::model::rvalue(Q, stan::model::cons_list(stan::model::index_uni(T), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), "Q"))), 
                        "assigning variable Q_p");
            current_statement_begin__ = 118;
            stan::model::assign(Q_sdi_p, 
                        stan::model::cons_list(stan::model::index_uni(1), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), 
                        elt_divide(1.0,stan::math::sqrt(diagonal(stan::model::rvalue(Q_p, stan::model::cons_list(stan::model::index_uni(1), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), "Q_p")))), 
                        "assigning variable Q_sdi_p");
            current_statement_begin__ = 119;
            stan::model::assign(R_p, 
                        stan::model::cons_list(stan::model::index_uni(1), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), 
                        quad_form_diag(stan::model::rvalue(Q_p, stan::model::cons_list(stan::model::index_uni(1), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), "Q_p"),stan::model::rvalue(Q_sdi_p, stan::model::cons_list(stan::model::index_uni(1), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), "Q_sdi_p")), 
                        "assigning variable R_p");
            current_statement_begin__ = 120;
            stan::model::assign(H_p, 
                        stan::model::cons_list(stan::model::index_uni(1), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), 
                        quad_form_diag(get_base1(R_p,1,"R_p",1),get_base1(D_p,1,"D_p",1)), 
            ...
            if (as_bool(logical_gte(ahead,2))) {
                ...
                for (int p = 2; p <= ahead; ++p) {
                    ...
                    stan::model::assign(u_p, 
                                stan::model::cons_list(stan::model::index_uni((p - 1)), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), 
                    ...
                    stan::model::assign(Q_p, 
                                stan::model::cons_list(stan::model::index_uni(p), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), 
                                stan::model::deep_copy(add(add(multiply(((1 - a_q) - b_q),S),multiply(a_q,multiply(stan::model::rvalue(u_p, stan::model::cons_list(stan::model::index_uni((p - 1)), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), "u_p"),transpose(stan::model::rvalue(u_p, stan::model::cons_list(stan::model::index_uni((p - 1)), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), "u_p"))))),multiply(b_q,stan::model::rvalue(Q_p, stan::model::cons_list(stan::model::index_uni((p - 1)), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), "Q_p")))), 
                                "assigning variable Q_p");
                    current_statement_begin__ = 135;
                    stan::model::assign(Q_sdi_p, 
                                stan::model::cons_list(stan::model::index_uni(p), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), 
                                elt_divide(1.0,stan::math::sqrt(diagonal(stan::model::rvalue(Q_p, stan::model::cons_list(stan::model::index_uni(p), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), "Q_p")))), 
                                "assigning variable Q_sdi_p");
                    current_statement_begin__ = 136;
                    stan::model::assign(R_p, 
                                stan::model::cons_list(stan::model::index_uni(p), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), 
                                quad_form_diag(stan::model::rvalue(Q_p, stan::model::cons_list(stan::model::index_uni(p), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), "Q_p"),stan::model::rvalue(Q_sdi_p, stan::model::cons_list(stan::model::index_uni(p), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), "Q_sdi_p")), 
                                "assigning variable R_p");
                    current_statement_begin__ = 137;
                    stan::model::assign(H_p, 
                                stan::model::cons_list(stan::model::index_uni(p), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), 
                                quad_form_diag(get_base1(R_p,p,"R_p",1),get_base1(D_p,p,"D_p",1)), 
                                "assigning variable H_p");
            ...
            current_statement_begin__ = 100;
            for (int k0__ = 0; k0__ < ahead; ++k0__) {
                stan::math::check_cov_matrix(function__,"Q_p[k0__]",Q_p[k0__]);
            }
            current_statement_begin__ = 101;
            current_statement_begin__ = 102;
            for (int k0__ = 0; k0__ < ahead; ++k0__) {
                stan::math::check_corr_matrix(function__,"R_p[k0__]",R_p[k0__]);
            }
            current_statement_begin__ = 103;
            ...
            for (int k_2__ = 0; k_2__ < nt; ++k_2__) {
                for (int k_1__ = 0; k_1__ < nt; ++k_1__) {
                    for (int k_0__ = 0; k_0__ < ahead; ++k_0__) {
                    vars__.push_back(Q_p[k_0__](k_1__, k_2__));
                    }
                }
            }
            for (int k_1__ = 0; k_1__ < nt; ++k_1__) {
                for (int k_0__ = 0; k_0__ < ahead; ++k_0__) {
                vars__.push_back(Q_sdi_p[k_0__][k_1__]);
                }
            }
            for (int k_2__ = 0; k_2__ < nt; ++k_2__) {
                for (int k_1__ = 0; k_1__ < nt; ++k_1__) {
                    for (int k_0__ = 0; k_0__ < ahead; ++k_0__) {
                    vars__.push_back(R_p[k_0__](k_1__, k_2__));
                    }
                }
            }
            for (int k_1__ = 0; k_1__ < nt; ++k_1__) {
                for (int k_0__ = 0; k_0__ < (ahead - 1); ++k_0__) {
                vars__.push_back(u_p[k_0__][k_1__]);
                }
            }
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        if (include_tparams__) {
            ...
            for (int k_2__ = 1; k_2__ <= nt; ++k_2__) {
                for (int k_1__ = 1; k_1__ <= nt; ++k_1__) {
                    for (int k_0__ = 1; k_0__ <= T; ++k_0__) {
                        param_name_stream__.str(std::string());
                        param_name_stream__ << "Q" << '.' << k_0__ << '.' << k_1__ << '.' << k_2__;
                        param_names__.push_back(param_name_stream__.str());
                    }
                }
            }
            for (int k_1__ = 1; k_1__ <= nt; ++k_1__) {
                for (int k_0__ = 1; k_0__ <= T; ++k_0__) {
                    param_name_stream__.str(std::string());
                    param_name_stream__ << "Q_sdi" << '.' << k_0__ << '.' << k_1__;
                    param_names__.push_back(param_name_stream__.str());
                }
            }
            for (int k_1__ = 1; k_1__ <= nt; ++k_1__) {
        ...
        for (int k_2__ = 1; k_2__ <= nt; ++k_2__) {
            for (int k_1__ = 1; k_1__ <= nt; ++k_1__) {
                for (int k_0__ = 1; k_0__ <= ahead; ++k_0__) {
                    param_name_stream__.str(std::string());
                    param_name_stream__ << "Q_p" << '.' << k_0__ << '.' << k_1__ << '.' << k_2__;
                    param_names__.push_back(param_name_stream__.str());
                }
            }
        }
        for (int k_1__ = 1; k_1__ <= nt; ++k_1__) {
            for (int k_0__ = 1; k_0__ <= ahead; ++k_0__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "Q_sdi_p" << '.' << k_0__ << '.' << k_1__;
                param_names__.push_back(param_name_stream__.str());
            }
        }
        for (int k_2__ = 1; k_2__ <= nt; ++k_2__) {
            for (int k_1__ = 1; k_1__ <= nt; ++k_1__) {
                for (int k_0__ = 1; k_0__ <= ahead; ++k_0__) {
                    param_name_stream__.str(std::string());
                    param_name_stream__ << "R_p" << '.' << k_0__ << '.' << k_1__ << '.' << k_2__;
                    param_names__.push_back(param_name_stream__.str());
                }
            }
        }
        for (int k_1__ = 1; k_1__ <= nt; ++k_1__) {
            for (int k_0__ = 1; k_0__ <= (ahead - 1); ++k_0__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "u_p" << '.' << k_0__ << '.' << k_1__;
                param_names__.push_back(param_name_stream__.str());
            }
        }
    }
    ...
    void unconstrained_param_names(std::vector<std::string>& param_names__,
        ...
        if (include_tparams__) {
            ...
            for (int k_1__ = 1; k_1__ <= (nt + ((nt * (nt - 1)) / 2)); ++k_1__) {
                for (int k_0__ = 1; k_0__ <= T; ++k_0__) {
                    param_name_stream__.str(std::string());
                    param_name_stream__ << "Q" << '.' << k_0__ << '.' << k_1__;
                    param_names__.push_back(param_name_stream__.str());
                }
            }
            for (int k_1__ = 1; k_1__ <= nt; ++k_1__) {
        ...
        for (int k_1__ = 1; k_1__ <= (nt + ((nt * (nt - 1)) / 2)); ++k_1__) {
            for (int k_0__ = 1; k_0__ <= ahead; ++k_0__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "Q_p" << '.' << k_0__ << '.' << k_1__;
                param_names__.push_back(param_name_stream__.str());
            }
        }
        for (int k_1__ = 1; k_1__ <= nt; ++k_1__) {
        ...
        for (int k_1__ = 1; k_1__ <= ((nt * (nt - 1)) / 2); ++k_1__) {
            for (int k_0__ = 1; k_0__ <= ahead; ++k_0__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "R_p" << '.' << k_0__ << '.' << k_1__;
                param_names__.push_back(param_name_stream__.str());
            }
        }
        for (int k_1__ = 1; k_1__ <= nt; ++k_1__) {
